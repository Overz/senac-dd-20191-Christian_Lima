...
public class MenuListar {
	...
	public MenuListar() {
		...
		UsuarioVO user1 = new UsuarioVO("Edson Arantes", "1@1.com", "pele10", nivelVO);
		UsuarioVO user2 = new UsuarioVO("Arthur Antunes", "2@1.com", "zico10",  nivelVO);
		UsuarioVO user3 = new UsuarioVO("Sócrates Brasileiro", "3@1.com", "socrates8", nivelVO);
		UsuarioVO user4 = new UsuarioVO("Matheus Pereira", "4@1.com", "matheus1", nivelVO);
		UsuarioVO user5 = new UsuarioVO("Jose carlos", "5@1.com", "zezinho10", nivelVO);
		UsuarioVO user6 = new UsuarioVO("Maria do Rosario", "6@1.com", "mary55", nivelVO);
